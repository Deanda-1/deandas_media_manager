...
export default async function LayoutsAdminPage() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <section className="bg-white rounded-xl shadow p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">Update the title and description shown on the public About page.</p>
